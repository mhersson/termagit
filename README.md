...
| `d`       | Diff popup                      |
| `X`       | Reset popup                     |
| `v`       | Revert popup (or enter visual mode on a diff line — see below) |
| `A`       | Cherry-pick popup               |
| `B`       | Bisect popup                    |
| `t`       | Tag popup                       |
| `w`       | Worktree popup                  |
...
visual selection mode instead of opening the Revert popup. This lets you stage
or unstage a custom subset of lines within a hunk.
